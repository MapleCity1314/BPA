...
const inventoryNodeAssets = [
  ...
  "nodes/core/doudian.inventory.product.snapshot.read@2.0.6.node.yaml",
  ...
  seedBrowser(store,[
    {
      ...
      adapterId:"doudian-experience",adapterVersion:"2.0.2"
    },
    {
      id:"doudian.experience.shop.snapshot.read",version:"2.0.2",riskLevel:"R1",
      permissions:["browser.dom.read","browser.dom.write","browser.tabs.read","browser.tabs.navigate"],
      adapterId:"doudian-experience",adapterVersion:"2.0.2"
    }
  ]);
...
function seedInventoryBrowser(store:SqlitePersistence):void {
  seedBrowser(store,[
    ...
    {
      id:"doudian.inventory.shop.activate",version:"1.0.6",riskLevel:"R1",
      permissions:["browser.dom.read","browser.dom.write","browser.tabs.read","browser.tabs.navigate"],
      adapterId:"doudian-inventory",adapterVersion:"2.0.6"
    },
    {
      id:"doudian.inventory.product.snapshot.read",version:"2.0.6",riskLevel:"R1",
...
describe("local Doudian business Workflow acceptance",() => {
  ...
  it("runs retired products, experience score, and inventory on one bounded browser",async () => {
    ...
    seedBrowser(store,[
      {
        id:"doudian.alliance.shops.discover",version:"2.0.12",riskLevel:"R2",
        permissions:["browser.dom.read","browser.dom.write","browser.tabs.read","browser.tabs.navigate"],
        adapterId:"doudian-alliance",adapterVersion:"2.0.12"
      },
      {
        id:"doudian.alliance.shop.retired-products.scan",version:"2.0.12",riskLevel:"R2",
        permissions:["browser.dom.read","browser.dom.write","browser.tabs.read","browser.tabs.navigate"],
        adapterId:"doudian-alliance",adapterVersion:"2.0.12"
      },
      {
    ...
    const retired = await runTrigger(service,store,{
      ...
      workflowVersion:"3.0.13",workflowInput:{ maxShops:100 }
    });
    ...
    const experience = await runTrigger(service,store,{
      ...
      workflowId:"doudian.experience-score.daily",workflowVersion:"2.0.2",
    ...
    const inventory = await runTrigger(service,store,{
      ...
      workflowId:"doudian.inventory.production-cycle",workflowVersion:"1.0.6",
