...
const inventoryNodeAssets = [
  ...
  "nodes/core/doudian.inventory.product.snapshot.read@2.0.1.node.yaml",
...
function seedInventoryBrowser(store:SqlitePersistence):void {
  seedBrowser(store,[
    ...
    {
      id:"doudian.inventory.shop.activate",version:"1.0.1",riskLevel:"R1",
      permissions:["browser.dom.read","browser.dom.write","browser.tabs.read","browser.tabs.navigate"],
      adapterId:"doudian-inventory",adapterVersion:"2.0.1"
    },
    {
      id:"doudian.inventory.product.snapshot.read",version:"2.0.1",riskLevel:"R1",
...
describe("local Doudian business Workflow acceptance",() => {
  ...
  it("runs retired products, experience score, and inventory on one bounded browser",async () => {
    ...
    seedBrowser(store,[
      {
        id:"doudian.alliance.shops.discover",version:"2.0.6",riskLevel:"R2",
        permissions:["browser.dom.read","browser.dom.write","browser.tabs.read","browser.tabs.navigate"],
        adapterId:"doudian-alliance",adapterVersion:"2.0.6"
      },
      {
        id:"doudian.alliance.shop.retired-products.scan",version:"2.0.6",riskLevel:"R2",
        permissions:["browser.dom.read","browser.dom.write","browser.tabs.read","browser.tabs.navigate"],
        adapterId:"doudian-alliance",adapterVersion:"2.0.6"
      },
      {
    ...
    const retired = await runTrigger(service,store,{
      ...
      workflowVersion:"3.0.7",workflowInput:{ maxShops:100 }
    });
    ...
    const inventory = await runTrigger(service,store,{
      ...
      workflowId:"doudian.inventory.production-cycle",workflowVersion:"1.0.1",
