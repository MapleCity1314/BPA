...
7. Verify `com.bpa.inventory-service`, the `0600` Unix socket, Trigger/Run state, lease rows, and absence of a listener on the retired `17650` Web port. Operator review is served by the operations control center, not this process.
